 ...
 */
public class DeleteEntityImage extends AsyncTask<Void, Void, Void> {
	...
	public DeleteEntityImage(int entityId, String imagePropertyName,
	...
	protected Void doInBackground(Void... params) {
		...
		try {
			...
			Log.e(Constants.TAG_ORCASDK, Constants.TAG_BACKEND
			...
			Log.e(Constants.TAG_ORCASDK, Constants.TAG_BACKEND + " Exception "
					+ e.getMessage());
			e.printStackTrace();
	...
	private boolean checkParameters() {
		...
		return entityId > 0 && imagePropertyName != null
