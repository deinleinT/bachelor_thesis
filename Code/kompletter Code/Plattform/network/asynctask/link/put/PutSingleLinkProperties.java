...
/**
 * AsyncTask-Klasse: Dieser Endpunkt ermöglicht es die Properties eines
 * bestimmten Link zwischen zwei Entitäten zu aktualisieren. BACKEND-ENDPUNKT:
 ...
 *            ableitet
 */
public class PutSingleLinkProperties<T extends Entity> extends
	...
	public PutSingleLinkProperties(int entityId, int objectId, String linkType,
	...
	protected Void doInBackground(Void... params) {
		...
		try {
			if (checkParameters()) {
				...
				statusCodeHttpPut = -1;
				errorMessage = "PUT-Request not possible: ivalid entityId/objectId, linkType, appName, apiKey or properties (id==0, null or empty)";
			}
		}
		catch (IOException e) {
	...
	private boolean checkParameters() {
		...
		return entityId > 0 && objectId > 0 && linkType != null
				...
				&& apiKey != null && !apiKey.isEmpty() && newProperties != null
