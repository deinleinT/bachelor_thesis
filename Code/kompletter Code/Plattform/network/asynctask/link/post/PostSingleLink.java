 ...
 *            ableitet
 */
public class PostSingleLink<T extends Entity> extends
	...
	public PostSingleLink(Link link, T entity, T objectEntity, String appName,
			String apiKey, IPostLinkCallback callback) {
	...
	private boolean checkParameters() {
		...
		return entityOne != null && objectEntity != null
				&& entityOne.getId() > 0 && objectEntity.getId() > 0
				&& link != null && !link.getType().isEmpty() && appName != null
				&& !appName.isEmpty() && apiKey != null && !apiKey.isEmpty()
				&& entityOne.getType() > 0 && objectEntity.getType() > 0
